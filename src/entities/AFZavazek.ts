...
export enum AFZavazekStavUzivK {
...
export enum AFZavazekStavOdpocetK {
...
export class AFZavazek extends AFEntity {
    ...
    polozkyDokladu?: Promise<AFZavazekPolozka[]>

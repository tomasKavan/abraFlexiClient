...
export enum AFZavazekPolozkaTypCenyDphK {
  bezDph = 'typCeny.bezDph', //bez DPH
  sDph = 'typCeny.sDph', //včetně DPH
}

export enum AFZavazekPolozkaTypSzbDphK {
...
export enum AFZavazekPolozkaTypVypCenyK {
...
export enum AFZavazekPolozkaStavUzivK {

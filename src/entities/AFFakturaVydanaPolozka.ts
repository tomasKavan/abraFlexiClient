...
export enum AFFakturaVydanaPolozkaTypPolozkyK {
  ...
  odpocetZdd = 'typPolozky.odpocetZdd', //Odpočet ZDD
  odpocetZalohy = 'typPolozky.odpocetZalohy', //Odpočet zálohy
  korekceOdpoctu = 'typPolozky.korekceOdpoctu', //Korekce odpočtu zálohy/ZDD
  korekceRekapitulace = 'typPolozky.korekceRekapitulace', //Korekce rekapitulace DPH
  zaokrPoOdpoctu = 'typPolozky.zaokrPoOdpoctu', //Položka zaokrouhlení po odpočtu záloh
}

export enum AFFakturaVydanaPolozkaTypCenyDphK {
  bezDph = 'typCeny.bezDph', //bez DPH
  sDph = 'typCeny.sDph', //včetně DPH
}

export enum AFFakturaVydanaPolozkaTypSzbDphK {
...
export enum AFFakturaVydanaPolozkaTypVypCenyK {
...
export enum AFFakturaVydanaPolozkaZaokrJakK {
  nahoru = 'zaokrJak.nahoru', //nahoru
  dolu = 'zaokrJak.dolu', //dolů
  matem = 'zaokrJak.matem', //matematicky
}

export enum AFFakturaVydanaPolozkaZaokrNaK {
...
export enum AFFakturaVydanaPolozkaStavUzivK {
...
export enum AFFakturaVydanaPolozkaEkokomK {
...
export class AFFakturaVydanaPolozka extends AFEntity {
    ...
    doklFak?: AFFakturaVydana

    // Poplatek k položce (db: IdPolFakPoplatek) - Poplatek k položce)
    poplatekParentPolFak?: AFFakturaVydanaPolozka

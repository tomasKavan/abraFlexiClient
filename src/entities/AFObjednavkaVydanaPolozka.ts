...
export enum AFObjednavkaVydanaPolozkaTypPolozkyK {
...
export enum AFObjednavkaVydanaPolozkaTypCenyDphK {
  bezDph = 'typCeny.bezDph', //bez DPH
  sDph = 'typCeny.sDph', //včetně DPH
}

export enum AFObjednavkaVydanaPolozkaTypSzbDphK {
...
export enum AFObjednavkaVydanaPolozkaObjednatK {

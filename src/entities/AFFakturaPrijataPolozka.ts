...
export enum AFFakturaPrijataPolozkaTypPolozkyK {
...
export enum AFFakturaPrijataPolozkaTypCenyDphK {
  bezDph = 'typCeny.bezDph', //bez DPH
  sDph = 'typCeny.sDph', //včetně DPH
}

export enum AFFakturaPrijataPolozkaTypSzbDphK {
...
export enum AFFakturaPrijataPolozkaTypVypCenyK {
...
export enum AFFakturaPrijataPolozkaZaokrJakK {
  nahoru = 'zaokrJak.nahoru', //nahoru
  dolu = 'zaokrJak.dolu', //dolů
  matem = 'zaokrJak.matem', //matematicky
}

export enum AFFakturaPrijataPolozkaZaokrNaK {
...
export enum AFFakturaPrijataPolozkaStavUzivK {
...
export enum AFFakturaPrijataPolozkaEkokomK {

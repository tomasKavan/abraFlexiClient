...
export enum AFCenikovyPohybProdejModulK {
...
export enum AFCenikovyPohybProdejTypPolozkyK {
...
export enum AFCenikovyPohybProdejTypCenyDphK {
  bezDph = 'typCeny.bezDph', //bez DPH
  sDph = 'typCeny.sDph', //včetně DPH
}

export enum AFCenikovyPohybProdejTypSzbDphK {
...
export enum AFCenikovyPohybProdejTypVypCenyK {
...
export enum AFCenikovyPohybProdejObjednatK {

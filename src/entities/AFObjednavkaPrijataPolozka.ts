...
export enum AFObjednavkaPrijataPolozkaTypPolozkyK {
...
export enum AFObjednavkaPrijataPolozkaTypCenyDphK {
  bezDph = 'typCeny.bezDph', //bez DPH
  sDph = 'typCeny.sDph', //včetně DPH
}

export enum AFObjednavkaPrijataPolozkaTypSzbDphK {
...
export enum AFObjednavkaPrijataPolozkaObjednatK {

...
export enum AFPoptavkaVydanaPolozkaTypPolozkyK {
...
export enum AFPoptavkaVydanaPolozkaTypCenyDphK {
  bezDph = 'typCeny.bezDph', //bez DPH
  sDph = 'typCeny.sDph', //včetně DPH
}

export enum AFPoptavkaVydanaPolozkaTypSzbDphK {
...
export class AFPoptavkaVydanaPolozka extends AFEntity {
    ...
    doklObch?: AFPoptavkaVydana

    // Poplatek k položce (db: IdPolObchPoplatek) - Poplatek k položce)
    poplatekParentPolObch?: AFPoptavkaVydanaPolozka

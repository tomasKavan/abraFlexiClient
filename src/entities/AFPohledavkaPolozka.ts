...
export enum AFPohledavkaPolozkaTypCenyDphK {
  bezDph = 'typCeny.bezDph', //bez DPH
  sDph = 'typCeny.sDph', //včetně DPH
}

export enum AFPohledavkaPolozkaTypSzbDphK {
...
export enum AFPohledavkaPolozkaTypVypCenyK {
...
export enum AFPohledavkaPolozkaStavUzivK {

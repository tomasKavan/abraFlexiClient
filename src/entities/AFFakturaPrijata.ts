...
export enum AFFakturaPrijataZamekK {
...
export enum AFFakturaPrijataStavUzivK {
...
export enum AFFakturaPrijataEkokomK {
...
export enum AFFakturaPrijataStavUhrK {
...
export enum AFFakturaPrijataStavOdpocetK {
...
export class AFFakturaPrijata extends AFEntity {
    ...
    polozkyDokladu?: Promise<AFFakturaPrijataPolozka[]>

...
export enum AFPoptavkaPrijataPolozkaTypPolozkyK {
...
export enum AFPoptavkaPrijataPolozkaTypCenyDphK {
  bezDph = 'typCeny.bezDph', //bez DPH
  sDph = 'typCeny.sDph', //včetně DPH
}

export enum AFPoptavkaPrijataPolozkaTypSzbDphK {
...
export enum AFPoptavkaPrijataPolozkaObjednatK {

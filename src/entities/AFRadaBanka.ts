...
export class AFRadaBanka extends AFEntity {
  static EntityPath: string = 'rada-banka'
  static EntityName: string = 'Dokladové řady - bankovní doklady'
  static EntityType: string = 'BANKA_RADA'

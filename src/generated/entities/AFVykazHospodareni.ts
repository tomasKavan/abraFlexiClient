...
export class AFVykazHospodareni extends AFEntity {
  static EntityPath: string = 'vykaz-hospodareni'
  static EntityName: string = 'Výkaz hospodaření za měsíc'
  static EntityType: string = 'VYKAZ_HOSPODARENI'

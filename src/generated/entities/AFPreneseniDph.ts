...
export class AFPreneseniDph extends AFEntity {
  ...
  static EntityName: string = 'Seznam zboží v režimu přenesení DPH'
  static EntityType: string = 'PRENESENI_DPH'
  ...
  omezPrenDanPovK?: OmezPrenDanPov | null

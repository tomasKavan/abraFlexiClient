...
import { AFTypUplatneniDaneZavazku } from './AFTypUplatneniDaneZavazku'
...
import { AFRadaUplatneniDaneZavazku } from './AFRadaUplatneniDaneZavazku'
...
import { AFUplatneniDaneZavazkuPolozka } from './AFUplatneniDaneZavazkuPolozka'
...
import { Zamek } from '../AFEntityEnums'
...
export class AFUplatneniDaneZavazku extends AFEntity {
  ...
  // Typ upl. daně - záv. (db: IdTypDokl) - Typ upl. daně - záv.)
  ...
  rada?: AFRadaUplatneniDaneZavazku | null
  ...
  // Položky faktur (type: UPLATNENI_DANE_ZAV_POLOZKA) - polozkyDokladu)
  polozkyDokladu?: AFUplatneniDaneZavazkuPolozka[]
  ...
  static propAnnotations: Record<string, TypeAnnotation> = {
    ...
    typDokl : {
      ...
      type: PropertyType.Relation,
      isArray: false,
      afClass: 'AFTypUplatneniDaneZavazku',
    ...
    rada : {
      ...
      type: PropertyType.Relation,
      isArray: false,
      afClass: 'AFRadaUplatneniDaneZavazku',
    ...
    polozkyDokladu : {
      ...
      type: PropertyType.Relation,
      isArray: true,
      afClass: 'AFUplatneniDaneZavazkuPolozka'
    },
    prilohy : {
      key: 'prilohy',
      type: PropertyType.Relation,

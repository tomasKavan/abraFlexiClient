...
export class AFTypUplatneniDaneZavazku extends AFEntity {
  static EntityPath: string = 'typ-uplatneni-dane-zavazku'
  static EntityName: string = 'Typy uplatnění daně - závazky'
  static EntityType: string = 'UPLATNENI_DANE_ZAV_TYP'
  ...
  radaVydej?: AFRadaUplatneniDaneZavazku | null

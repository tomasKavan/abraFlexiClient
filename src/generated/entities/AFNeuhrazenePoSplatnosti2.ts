...
import { TypPohybu, StavUziv, Zamek, ZaokrJak, ZaokrNa } from '../AFEntityEnums'

export class AFNeuhrazenePoSplatnosti2 extends AFEntity {
  static EntityPath: string = 'neuhrazene-po-splatnosti-2'
  static EntityName: string = 'Neuhrazené po splatnosti - uhrazené'
  static EntityType: string = 'NEUHRAZENE_PO_SPLATNOSTI_2'
  ...
  // Kód úhrady (db: ) - Kód úhrady)
  kodUhrady?: string | null
  // Částka úhrady (db: ) - Částka úhrady)
  castkaVazby?: Big | null
  // Úhrada (db: ) - Úhrada)
  uhrada?: AFInterniDoklad | null

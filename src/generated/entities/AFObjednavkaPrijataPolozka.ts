...
import { AFObjednavkaPrijata } from './AFObjednavkaPrijata.js'
import { AFUzivatelskaVazba } from './AFUzivatelskaVazba.js'


import { TypPolozky, TypCeny, TypSzbDph, Objednat, TypVypCeny } from '../AFEntityEnums.js'

export enum AFObjednavkaPrijataPolozkaAction {
  // Storno položky
  Storno = 'storno',
}

export class AFObjednavkaPrijataPolozka extends AFEntity {
  static EntityPath: string = 'objednavka-prijata-polozka'
  static EntityName: string = 'Položky přijaté objednávky'
  static EntityType: string = 'OBJEDNAVKA_IN_POLOZKA'
  static Actions = AFObjednavkaPrijataPolozkaAction
  ...
  // Rezervovat na skladě (db: Rezervovat) - Rezervovat na skladě)
  rezervovat?: boolean | null
  // Plán MJ (db: MnozMjPlan) - Plánované množství)
  mnozMjPlan?: Big | null
  // Real. MJ (db: MnozMjReal) - Realizované množství)
  mnozMjReal?: Big | null
  // Zbývá. MJ (db: mnozMj - mnozMjReal) - Zbývající množství)
  mnozMjZbyva?: Big | null
  // Výrobce (db: ) - Výrobce)
  ...
  doklObch?: AFObjednavkaPrijata | null
  // Rezervovat MJ (db: RezervovatMj) - Rezervovat MJ)
  rezervovatMj?: Big | null
  // Objednáno MJ (db: ObjednanoMj) - Objednáno MJ)
  objednanoMj?: Big | null
  // Poplatek k položce (db: IdPolObchPoplatek) - Poplatek k položce)
  poplatekParentPolObch?: AFObjednavkaPrijataPolozka | null

...
export enum AFNabidkaPrijataAction {
  // Storno
  Storno = 'storno',
}
...
export class AFNabidkaPrijata extends AFEntity {
  ...
  static EntityName: string = 'Přijaté nabídky'
  static EntityType: string = 'NABIDKA_IN'
  static Actions = AFNabidkaPrijataAction
  ...
  cisSml?: string | null
  // Datum nabídky (db: DatObj) - Datum nabídky)
  datObj?: Date | null
  ...
  typDokl?: AFTypNabidkyPrijate | null
  // Měna (db: IdMeny) - Měna)
  mena?: AFMena | null
  ...
  rada?: AFRadaNabidkyPrijate | null
  ...
  // Typ objednávky vydané (db: IdTypDoklNabFak) - Typ objednávky vydané)
  typDoklNabFak?: AFTypObjednavkyVydane | null
  ...
  // Položky nabídky přijaté (type: NABIDKA_IN_POLOZKA) - polozkyDokladu)
  polozkyDokladu?: AFNabidkaPrijataPolozka[]
  ...
  static propAnnotations: Record<string, TypeAnnotation> = {
    ...
    polozkyDokladu : {
      ...
      type: PropertyType.Relation,
      isArray: true,
      afClass: 'AFNabidkaPrijataPolozka'
    },
    prilohy : {
      key: 'prilohy',
      type: PropertyType.Relation,

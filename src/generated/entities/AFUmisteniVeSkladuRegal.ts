...
export class AFUmisteniVeSkladuRegal extends AFEntity {
  static EntityPath: string = 'umisteni-ve-skladu-regal'
  static EntityName: string = 'Umístění ve skladu'
  static EntityType: string = 'UMISTENI_VE_SKLADU_REGAL'
  ...
  typUmisteniK?: TypUmisteniSklad | null

...
export class AFObratovaPredvaha extends AFEntity {
  static EntityPath: string = 'obratova-predvaha'
  static EntityName: string = 'Obratová předvaha'
  static EntityType: string = 'OBRATOVA_PREDVAHA'

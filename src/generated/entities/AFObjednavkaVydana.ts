...
import { AFRadaObjednavkyVydane } from './AFRadaObjednavkyVydane.js'
...
import { AFObjednavkaVydanaPolozka } from './AFObjednavkaVydanaPolozka.js'
...
export enum AFObjednavkaVydanaAction {
  // Storno
  Storno = 'storno',
}

export class AFObjednavkaVydana extends AFEntity {
  static EntityPath: string = 'objednavka-vydana'
  static EntityName: string = 'Vydané objednávky'
  static EntityType: string = 'OBJEDNAVKA_OUT'
  static Actions = AFObjednavkaVydanaAction
  ...
  typDokl?: AFTypObjednavkyVydane | null
  // Měna (db: IdMeny) - Měna)
  mena?: AFMena | null
  ...
  rada?: AFRadaObjednavkyVydane | null
  ...
  // Typ příjemky (db: IdTypDoklNabFak) - Typ příjemky)
  typDoklNabFak?: AFTypSkladovyPohyb | null
  ...
  // Položky objednávky vydané (type: OBJEDNAVKA_OUT_POLOZKA) - polozkyDokladu)
  polozkyDokladu?: AFObjednavkaVydanaPolozka[]
